			...
			<section id="show-commerceObject" class="first">
				<div class="span12 form-horizontal">
						...
						<div class="control-group">
							...
							<div class="controls show-style"><g:fieldValue bean="${programXMLInstance}" field="title"/></div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls show-style"><g:fieldValue bean="${programXMLInstance}" field="filename"/></div>
						</div>
							...
							<div class="controls show-style" style="text-align: left;">
								<ul class="list-group">
									<g:each in="${programXMLInstance.secureProgram}" var="s">
										<li class="list-group-item">${s.onlineIsbn}: <g:link controller="secureProgram" action="show" id="${s.id}">${s?.encodeAsHTML()}</g:link></li>
									</g:each>
								</ul></div>
						</div>												
				</div>
