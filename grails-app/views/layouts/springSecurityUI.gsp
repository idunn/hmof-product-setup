...
<div class="navbar-header">
			...
			<a class="navbar-brand" href="${createLink(uri: '/')}">
				<%--Commented out as not working in WAR --%>
	...
	<div>
		...
		<div >
			...
			<div id='s2ui_header_body'>
				...
				<sec:ifLoggedIn>
				<span style="color:#DCDCDC;">Logged in as <sec:username/> </span>(<g:link controller='logout' style="color:#428BcA;">Logout</g:link>)
				</sec:ifLoggedIn>
				<sec:ifNotLoggedIn>
					<a href='#' id='loginLink' style="color:#428BcA;">Login</a>
				</sec:ifNotLoggedIn>
