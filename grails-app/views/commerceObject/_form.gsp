	...
	<section>
		...
		<div
			...
			<label for="objectReorderNumber" class="control-label col-sw-1"><g:message
					...
					<div  class="controls"> 
					<g:select name="objectReorderNumber" from="${0..12}" class="form-control" value="${fieldValue(bean: commerceObjectInstance, field: 'objectReorderNumber')}" data-toggle="tooltip" data-placement="right" data-container="body" title="Determines the content display sequence on the Resource Gadget" />
