	...
	<body>
		...
		<div id="show-program" class="content scaffold-show" role="main">
			...
			<ol class="property-list program">
				...
				<li class="fieldcontain">
					<span id="discipline-label" class="property-label"><g:message code="program.discipline.label" default="Discipline" /></span>
					
						<span class="property-value" aria-labelledby="discipline-label"><g:fieldValue bean="${programInstance}" field="discipline"/></span>
				...
				<li class="fieldcontain">
					<span id="bundles-label" class="property-label"><g:message code="program.bundles.label" default="Bundles" /></span>
					
						<g:each in="${programInstance.bundles}" var="b">
						<span class="property-value" aria-labelledby="bundles-label"><g:link controller="bundle" action="show" id="${b.id}">${b?.encodeAsHTML()}</g:link></span>
						</g:each>
