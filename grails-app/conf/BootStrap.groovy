	...
	def init = { servletContext ->
		...
		if(Program.where{}.list().isEmpty()){
			...
			SecureProgram.withTransaction{
				...
				onlineIsbn:'9780123456781', copyright:2016, securityWord:'algebra', includeDashboardObject:true, includeEplannerObject:false,knowledgeGraphIdDev:'513429ef-7ad2-422d-bd21-e60ae756054b',curriculumArea:'Mathematics',essayGraderPrompts:'Middle School', contentType:ct3).addToCommerceObjects(cob1).addToCommerceObjects(cob7).save(failOnError:true)
				...
				onlineIsbn:'9780123456792', copyright:2016, securityWord:'reflection', includeDashboardObject:true, includeEplannerObject:true, knowledgeGraphIdDev:'513429ef-7ad2-422d-bd21-e60ae756054d',curriculumArea:'Mathematics',essayGraderPrompts:'High School', contentType:ct3).addToCommerceObjects(cob3).save(failOnError:true)
				def sp4 = new SecureProgram (productName:'Visual Math: Teacher Edition, Grade 10', registrationIsbn:'054423882X',
				onlineIsbn:'9780123456793', copyright:2016, securityWord:'equal', includeDashboardObject:false, includeEplannerObject:false, knowledgeGraphIdDev:'513429ef-7ad2-422d-bd21-e60ae756054e',curriculumArea:'Mathematics',essayGraderPrompts:'High School', contentType:ct3).addToCommerceObjects(cob4).save(failOnError:true)
				def sp5 = new SecureProgram (productName:'Visual Math: Teacher Edition, Grade 11', registrationIsbn:'054423883X',
				onlineIsbn:'9780123456794', copyright:2016, securityWord:'multiply', includeDashboardObject:true, includeEplannerObject:true, knowledgeGraphIdDev:'513429ef-7ad2-422d-bd21-e60ae756054f',curriculumArea:'Mathematics',essayGraderPrompts:'High School', contentType:ct3).addToCommerceObjects(cob5).save(failOnError:true)
				def sp6 = new SecureProgram (productName:'Visual Math: Teacher Edition, Grade 12', registrationIsbn:'054423884X',
				onlineIsbn:'9780123456795', copyright:2016, securityWord:'essay', includeDashboardObject:true, includeEplannerObject:true, knowledgeGraphIdDev:'513429ef-7ad2-422d-bd21-e60ae756055b',curriculumArea:'Mathematics',essayGraderPrompts:'High School', contentType:ct3).addToCommerceObjects(cob6).addToCommerceObjects(cob7).save(failOnError:true)
